...
<form name='frm_approval' method='post' id='frm_approval'>
	<table id='approvalTable' border="1">
		...
		<tr>
			<td>내용</td>
			<td colspan="10"><textarea name='subject' id='content'></textarea></td>
		</tr>
		<tr>
			<td>예상비용</td>
			<td colspan="10"><textarea name='price' id='contentsmall'></textarea></td>
		</tr>
		<tr>
			<td rowspan="2">결재인</td>
			<td>과장</td>
			...
			<td>사장</td>
			<td rowspan="2">비고</td>
			<td rowspan="2" colspan="6"><textarea name='remark' id='tmi'></textarea></td>
		</tr>
		<tr>
			<td class='stamp'></td>
			<td class='stamp'></td>
